...
adb shell "chmod 777 ${ANDROID_EXEC_DIR}/${BINARY_NAME}; cd ${ANDROID_EXEC_DIR}; ./${BINARY_NAME} 1>${ANDROID_EXEC_DIR}/${BINARY_NAME}.errorlog 2>&1; echo -n exit $?" 1>ec.sh 2>>./run_on_android_log.txt
